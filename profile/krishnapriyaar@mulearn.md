...
My all-time favourite footballer is Lionel Messi. He is my favourite because of his amazing skills, teamwork, and humble personality. 
What inspires me the most is their hard work, humility, and determination. Even after facing many challenges and losing important finals, he never gave up. He kept working hard and finally won the FIFA World Cup. His journey teaches me to stay focused, be patient, and always believe in myself.
...
I watched the match at home with my family, and we celebrated together after Argentina won.
...
- I actively participate in technical communities and events to improve my skills and learn from others. I have participated in the NASA Space Apps Challenge, a hackathon as part of Women's Day  and the μLearn Summer Internship program. These experiences helped me strengthen my problem-solving, teamwork, and communication skills while working on real-world challenges. I also enjoy collaborating with fellow learners, exploring new technologies, and continuously improving through community-driven learning and hands-on projects.
...
I use a variety of tools in my daily workflow to learn, build, and manage projects efficiently. For programming, I use Visual Studio Code , Python IDLE,  Git, and GitHub for coding and version control. I use ChatGPT to learn new concepts, solve coding problems, and improve my projects. Render for deploying  applications, and Power BI and Microsoft Excel for data analysis and visualization. I also use web browsers, online documentation, and learning platforms to continuously improve my technical skills and stay updated with new technologies.
